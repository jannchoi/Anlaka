                ...
                ScrollView {
                        VStack(spacing: 16) {
                            Group {
                                ...
                                .font(.subheadline)
                                .foregroundColor(container.model.isEmailValid ? Color.oliveMist : Color.deselectedOption)
                            ...
                            Button(action: {
                                ...
                                Text("완료")
                                    ...
                                    .padding()
                                    .background(container.model.isSignUpButtonEnabled ? Color.oliveMist : Color.deselectedOption)
                                    .cornerRadius(12)
                            }
